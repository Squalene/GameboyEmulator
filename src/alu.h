...
/**
* @brief returns wether the flag is set or not
*
...
#define has_C(X) has_flag(X, FLAG_C)
#define has_H(X) has_flag(X, FLAG_H)
#define has_N(X) has_flag(X, FLAG_N)
#define has_Z(X) has_flag(X, FLAG_Z)
