...
#define CLAMP15(x) (((x) < 0) || ((x) > 15) ? 0 : (x))

#define CLAMP31(x) (((x) < 0) || ((x) > 31) ? 0 : (x))
...
/**
 * @brief Gets the bit at a given index on 16 bit
 *
 * @param value value to get the bit from
 * @param index index of the bit
 * @return the bit at a given index
...
/**
 * @brief Gets the bit at a given index on 32 bit
 *
 * @param value value to get the bit from
 * @param index index of the bit
 * @return the bit at a given index
...
/**
 * @brief Returns a join of v1 and v2 where the index LSB bit of result
 *
 * @param v1 value from which we take the [0, index[ LSB
 * @param v2 value for the rest of the bits
 * @return a join of v1 and v2
*/
