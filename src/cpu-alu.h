...
// ======================================================================
/**
* @brief Our macros for flag sources for ALU operations (ZNHC)
*/
#define ADD_NON_ZERO_FLAGS_SRC CPU,   CLEAR,   ALU,   ALU
#define BIT_FLAGS_SRC CLEAR, CLEAR, SET, CPU //CLEAR the first one, will be set later
// ======================================================================
/**
...
// ======================================================================
/**
* @brief Executes an ALU instruction étantZ1H-, 
 ...
 * @return Error code
 */
int cpu_combine_alu_flags(cpu_t* cpu,flag_src_t Z, flag_src_t N, flag_src_t H, flag_src_t C);
